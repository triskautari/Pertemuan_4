    ...
    <div class="row clearfix">
      <div class="">
        <form>
          ...
          <div class="input_field"> <span><i aria-hidden="true" class="fa fa-lock"></i></span>
            <input type="password" name="password" placeholder="Ulangi Password" required />
          </div>
          <div class="row clearfix">
            <div class="col_half">
            ...
            <div class="col_half">
              ...
              <label for="rd1">Pria</label>
              <input type="radio" name="radiogroup1" id="rd2">
              <label for="rd2">Wanita</label>
              </div>
          ...
          <label for="cb2">Terima pemberitahuan</label>
            </div>
